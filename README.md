...
- Fast switching: `j`/`k` and arrows switch once the highlight rests on a session row (no `Enter`), plus `Tab`, `1`-`9`, session reordering, hide/restore, creation, and kill actions.
