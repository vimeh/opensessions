...
- Fast switching: `j`/`k` and arrows switch once the highlight rests on a session row (no `Enter`), wrap around at the top/bottom of the list, plus `Tab`, `1`-`9`, session reordering, hide/restore, creation, and kill actions.
